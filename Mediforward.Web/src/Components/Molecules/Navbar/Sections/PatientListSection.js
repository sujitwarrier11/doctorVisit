          ...
          >
            ...
            <Flex mx="15px">
              ...
              <Flex width="25%" mr="4px">
                <Button
                  onClick={() => {
                    if (onClick) onClick({ ...patient, voiceCall: true });
                    dispatch(
                      navigateToRoom({
                        ...patient,
...
const PatientListSection = ({ theme, patientList, clickHandler }) => {
  const dispatch = useDispatch();
...
export default withTheme(PatientListSection);
