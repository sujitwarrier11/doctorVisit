...
namespace Mediforward.Data.Migrations
{
    ...
    [Migration("20210122172406_notificationTemplates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mediforward.Data.Entities.DoctorNotes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    <!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Transitional//EN"" ""https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"">
                     ...
                     <body style=""margin:0px; padding:0px;"" >
                         <div style=""display: flex; box-sizing: border-box; flex-direction: column; align-items: center; justify-content: center; background-color: {0}; width:100%;"">
                            ...
                            TemplateType = "RoomInviteWithCode"
                        },
                        new
                        {
                            Id = 3,
                            AddedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TemplateContent = "{0} now in the {1} waiting room. click the link to start consultation: {2}",
                            TemplateType = "RoomInviteSMS"
                        },
                        new
                        {
                            Id = 4,
                            AddedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TemplateContent = "{0} now in the {1} waiting room. click the link to start consultation: {2}",
                            TemplateType = "RoomInviteSMSWithCode"
                        },
                        new
                        {
                            Id = 5,
                    ...
                    <!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Transitional//EN"" ""https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"">
                     ...
                     <body style=""margin:0px; padding:0px;"" >
                         <div style=""display: block; box-sizing: border-box; background-color: {0}; width:100%;"">
                            ...
                            TemplateType = "Patientjoined"
                        },
                        new
                        {
                            Id = 7,
                            AddedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TemplateContent = "Patient {0} has joined room {1}",
                            TemplateType = "PatientjoinedSMS"
                        });
                });
            ...
            modelBuilder.Entity("Mediforward.Data.Entities.ForgotPasswordValidationKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
